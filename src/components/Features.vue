  ...
  <section class="mt-32 mx-12">
        ...
        <div class="mt-24">
            ...
            <div class="block lg:flex">
                <!-- First feature -->
                <div class="md:flex items-center mx-auto lg:mr-10" style="background: url(../assets/features-1-bg.png) no-repeat right; background-size: contain;">
                    <div class="md:w-1/2">
                        <img class="mx-auto" src="../assets/features-1.png" alt="">
                    </div>
                ...
                <!-- Second feature -->
                <div class="md:flex items-center mx-auto mt-16 lg:mt-0 lg:ml-10" style="background: url(../assets/features-2-bg.png) no-repeat right; background-size: contain;">
                    <div class="md:w-1/2">
                        <img src="../assets/features-2.png" alt="" class="mx-auto">
                    </div>
                    <div class="md:w-1/2 text-center md:text-left ml-6 py-4">
                        <h1 class="text-3xl text-blue-900">
            ...
            <div class="block lg:flex mt-16">
                <!-- Third feature -->
                <div class="md:flex items-center mx-auto mt-16 lg:mt-0 lg:mr-10" style="background: url(../assets/features-3-bg.png) no-repeat right; background-size: contain;">
                    <div class="md:w-1/2">
                        <img src="../assets/features-3.png" alt="" class="mx-auto">
                    </div>
                    <div class="md:w-1/2 text-center md:text-left ml-6 py-4">
                        <h1 class="text-3xl text-blue-900">
                ...
                <!-- Fourth feature -->
                <div class="md:flex items-center mx-auto mt-16 lg:mt-0 lg:ml-10" style="background: url(../assets/features-4-bg.png) no-repeat right; background-size: contain;">
                    <div class="md:w-1/2">
                        <img src="../assets/features-4.png" alt="features-4-bg" class="mx-auto">
                    </div>
                    <div class="md:w-1/2 text-center md:text-left ml-6 py-4">
                        <h1 class="text-3xl text-blue-900">
